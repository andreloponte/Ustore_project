				...
				switch (esc)
				{
					case 1:
						...
						do
						{
							...
							{
								System.out.println("Usuario já existente. Deseja adicionar outro usuario? S / N\n");
								continuar = new Scanner(System.in).nextLine();
							}
					...
					case 2:
						...
						while (laco3 < 2){
							...
							switch (esc){
								...
								case 2: //Consultar Atendimento Específico
									laco4 = 1;
									while (laco4 < 2){
										System.out.println("\n1 - Consultar Nome do Cliente");
										System.out.println("2 - Consultar CPF");
										System.out.println("3 - Consultar Placa do Veículo");
										...
										switch (escolha3){
											...
											case 3: //Consultar Placa do Veículo
											...
											case 4: //Consultar Atendente
												System.out.println("\nDigite o nome do responsável pelo atendimento:\n");
												consultastr = new Scanner(System.in).nextLine();
												pos = 0;
												for (Atendimento n:Cadastro){
								...
								default:
									System.out.println("\nEssa opção não existe, por favor tente outra.\n");
								break;
							}
						}
					break;
					...
					case 3:
						...
						while (z < 2)
						{
							...
							System.out.println("Deseja fazer uma nova exclusão?\n");
