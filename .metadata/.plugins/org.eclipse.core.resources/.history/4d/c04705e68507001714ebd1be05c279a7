...
//							System.out.println(x);
							...
							novousuario.put("Criação", created);
							novousuario.put("Modificação", modified);
							...
							else
							{
								...
								System.out.println(erro+" já cadastrado.");
...
/*	Não está retornando o resultado esperado
 							case 2: //Consultar Usuario Específico
									laco2 = 1;
									while (laco2 < 2){
...
//								System.out.println("\nData Cadastro\t\t"+n.created+"\nUltima modificacao\t"+n.modified);
							...
							else
							{
								...
								id = (((Aplicacao) Cadastro.get(esc)).getId());
								modified = new Date();
								nusuario.put("Data Exclusão", modified);
								Usuario u = repositorioUsuario.obterPorId(id);
